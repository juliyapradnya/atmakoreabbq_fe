...
export default {
  ...
  data() {
    return {
      ...
      snackbar: false,
      items: [
        { text: "Bahan", icon: "mdi-shaker", to: "/chefbahan" },
        { text: "Pesanan", icon: "mdi-calendar-edit", to: "/chefpesanan" },
        { text: "Stok Masuk", icon: "mdi-cart-arrow-down", to: "/chefstok" },
        { text: "Stok Keluar", icon: "mdi-cart-arrow-up", to: "/chefhistorystok" },
        { text: "Stok Terbuang", icon: "mdi-cart-remove", to: "/chefstokterbuang" },
      ],
    };
  },
  methods: {
