...
export default {
  ...
  data() {
    return {
      ...
      snackbar: false,
      items: [
        { text: "Customer", icon: "mdi-account", to: "/waitercustomer" },
        { text: "Reservasi", icon: "mdi-calendar-clock", to: "/waiterreservasi" },
        { text: "Pesanan", icon: "mdi-calendar-edit", to: "/waiterpesanan" },
